...
export const ProjectDetailEn = ({ detailData }: ProjectDetailProps) => {
        ...
        <Box>
          ...
          >
            <Box sx={{ width: '35rem' }}>
              ...
              >
                <Typography sx={{ width: '10rem' }}>{t('language')}</Typography>
              ...
              >
                ...
                <Typography sx={{ width: '30rem' }}>{project.tools}</Typography>
              </Stack>
            </Box>
            <Box sx={{ width: '25rem' }}>
              {project.pic_url && (
